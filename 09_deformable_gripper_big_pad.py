...
def soft_body(boxId):
    ...
    cube2Id = p.loadSoftBody("vtk_objects/pad_big.vtk", basePosition = [0.15+0.40, -0.15, 1.13-0.235], baseOrientation = [ 0, -0.3989761, 0, 0.9169613 ], 
                            scale = 1, mass = 0.1, 
                            useNeoHookean = 1, NeoHookeanMu = 600, NeoHookeanLambda = 100, 
                            NeoHookeanDamping = 0.1, useSelfCollision = 1, frictionCoeff = .5, 
                            collisionMargin = 0.001)
    
    cubeId = p.loadSoftBody("vtk_objects/pad_big.vtk", basePosition = [-0.15-0.42, -0.15, 1.13-0.20], baseOrientation = [ 0, 0.3989761, 0, 0.9169613 ], 
                            scale = 1, mass = 0.1, 
                            useNeoHookean = 1, NeoHookeanMu = 600, NeoHookeanLambda = 100, 
                            NeoHookeanDamping = 0.1, useSelfCollision = 1, frictionCoeff = .5, 
                            collisionMargin = 0.001)
